    ...
    public void typeText(WebElement element, String text, String log) throws Exception {
        ...
        while (retryCount < maxRetries) {
            try {
                ...
                System.out.println(getCurrentTimeAndDate() + " Typed: " + text + " - " + log);
                break;
            } catch (Exception e) {
                retryCount++;
                System.out.println("Retry: " + retryCount + " to click on" + log);
                if (retryCount == maxRetries) {
                    e.printStackTrace();
                    System.out.println(e.getMessage());
                    baseTest.reportScreenshot("failedType", "Failed to type to element");
    ...
    public void typeText(WebElement element, Keys key, String log) throws Exception {
        ...
        while (retryCount < maxRetries) {
            try {
                ...
                System.out.println(getCurrentTimeAndDate() + " Typed: " + key + " - " + log);
                break;
            } catch (Exception e) {
                retryCount++;
                System.out.println("Retry: " + retryCount + " to click on" + log);
